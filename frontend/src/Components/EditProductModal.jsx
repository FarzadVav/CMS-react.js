...
function EditProductModal(props) {
  ...
  useEffect(() => {
    productNameRef.current.value = props.productDetails[0].title
    productPriceRef.current.value = props.productDetails[0].price
  ...
  return (
    <div className={props.showEditModal ? 'bg-modal' : 'hidden'}>
      <div className='bg-white flex flex-col justify-center items-center gap-3 rounded-2xl p-9'>
        <ProductInput
          width='w-full'
