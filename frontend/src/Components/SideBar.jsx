...
function SideBar() {
  return (
    <div className='w-full h-full flex flex-col items-center gap-3'>
      ...
      <NavLink to={'/'} className={link => link.isActive ? 'navLink-active' : 'navLink'}>
        صفحه اصلی
      ...
      <NavLink to={'/products'} className={link => link.isActive ? 'navLink-active' : 'navLink'}>
        محصولات
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="duration-0 w-5 h-5">
      ...
      <NavLink to={'/users'} className={link => link.isActive ? 'navLink-active' : 'navLink'}>
        کاربران
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="duration-0 w-5 h-5">
      ...
      <NavLink to={'/orders'} className={link => link.isActive ? 'navLink-active' : 'navLink'}>
        سفارشات
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="duration-0 w-5 h-5">
      ...
      <NavLink to={'/comments'} className={link => link.isActive ? 'navLink-active' : 'navLink'}>
        کامنت ها
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="duration-0 w-5 h-5">
      ...
      <NavLink to={'/offs'} className={link => link.isActive ? 'navLink-active' : 'navLink'}>
        کد تخفیف
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="duration-0 w-5 h-5">
