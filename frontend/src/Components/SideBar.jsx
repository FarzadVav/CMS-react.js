    ...
    <div className='w-full h-full flex flex-col justify-center items-center gap-3 p-3'>
      ...
      <NavLink to={'/products'}
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"
          className='duration-0 w-5 h-5'>
          <path className='duration-0' strokeLinecap="round" strokeLinejoin="round" d="M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" />
        </svg>
      </NavLink>
      <NavLink to={'/users'}
        className={link => link.isActive ? 'btn btn-white' : 'btn btn-out-white'}>
