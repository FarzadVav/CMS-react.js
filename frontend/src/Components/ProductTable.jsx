  ...
  return (
    <table className='w-full'>
      ...
      <tbody className='w-full'>
        <tr className='w-full flex items-center p-3 border-b border-slate-200'>
          ...
          <td className='w-3/12 font-light'>روغن زیتون</td>
          <td className='w-2/12 font-light'>127,000</td>
          <td className='w-2/12 font-light'>52</td>
