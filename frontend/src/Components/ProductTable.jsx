...
import { getAllProducts } from '../utility/connections'
          ...
          allProducts.map(product => (
            <tr key={product.id} className='w-full flex items-center p-3 border-b border-slate-200'>
              ...
              <td className='w-3/12 flex justify-center items-center gap-6'>
                ...
                <div data-editid={product.id}
                  className='border border-blue-500 text-blue-500 w-10 h-10 rounded-full
                  flex justify-center items-center
