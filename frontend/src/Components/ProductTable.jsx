  ...
  return (
    <table className='w-full'>
      <thead className='bg-slate-200 text-slate-700 w-full flex items-center p-3 rounded-t-2xl'>
        ...
        <th className='text-center w-3/12 font-light'>عملیات</th>
      </thead>
      <tbody className='w-full flex items-center p-3 border-b border-slate-200'>
        ...
        <tr className='text-right w-3/12 flex justify-center items-center gap-6'>
          <div className='bg-slate-500 w-10 h-10 rounded-full flex justify-center items-center
            cursor-pointer ring-1 ring-slate-500 hover:ring-offset-2'>
          ...
          <div className='bg-blue-500 w-10 h-10 rounded-full flex justify-center items-center
            cursor-pointer ring-1 ring-blue-500 hover:ring-offset-2'>
          ...
          <div className='bg-red-500 w-10 h-10 rounded-full flex justify-center items-center
            cursor-pointer ring-1 ring-red-500 hover:ring-offset-2'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="stroke-white w-6 h-6">
